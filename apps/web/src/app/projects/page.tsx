    ...
    <div className="min-h-screen bg-background">
      <div className="pt-6 px-6 flex items-center justify-between w-full h-16">
        ...
        <div className="block md:hidden">
          {isSelectionMode ? (
            ...
            <CreateButton onClick={openCreateProjectDialog} />
          )}
        </div>
      </div>
      <main className="max-w-6xl mx-auto px-6 pt-6 pb-6">
        ...
        {isLoading || !isInitialized ? (
          ...
          <NoProjects onCreateProject={openCreateProjectDialog} />
        ) : sortedProjects.length === 0 ? (
          <NoResults
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Name the project before opening the editor. Uploaded assets will be
            stored under this project name.
          </DialogDescription>
        </DialogHeader>
