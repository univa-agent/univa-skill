...
trigger_keywords: [guochao, ink wash, Chinese style, ancient style, landscape painting]
match_rule:
...
optimization_guide:
  prompt_enhancement: Use ink-wash brush edges, rice-paper grain, negative space, layered ink gradients, calligraphy rhythm, traditional motifs, and poetic weather.
