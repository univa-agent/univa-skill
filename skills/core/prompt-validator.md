# Prompt Validator - Core Skill

## When to Use

Use immediately before any generation tool call that sends prompt text to a model.
...
Reject or revise prompts that are too vague, missing core components, conflicting, unsafe, unsupported by research, or not aligned with the approved plan. Validation may clarify and expand wording, but it must not change approved intent, timing, references, or constraints.
