# Video Tracking - Core Skill

## When to Use

Use for referring video segmentation and tracking masks.
...
Tracking requires a clear target expression/label, source video path, output mask policy, and validation that the returned mask or segmentation artifacts exist and match the request.
