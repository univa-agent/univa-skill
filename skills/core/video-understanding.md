# Video Understanding - Core Skill

## When to Use

Use for read-only analysis of video content.
...
Understanding is read-only and does not require media mutation approval unless it triggers downstream generation/editing. Record analysis dimensions, source path, limitations, and structured findings.
