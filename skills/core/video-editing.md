# Video Editing - Core Skill

## When to Use

Use for depth modification, style transfer, repainting, and pose-reference video editing.
...
Editing requires source analysis, preservation rules, an exact edit proposal, selected tool and parameters, expected output, review artifact, and explicit approval before mutation. Prefer new output artifacts; do not overwrite the source unless approved.
