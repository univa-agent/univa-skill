# Wavespeed Image Gen - Core Skill

## When to Use

Use when calling image generation, image-to-image, or sequential image generation tools.
...
Image prompts must include subject, composition, style, aspect/size, reference handling, negative constraints, count, and output policy. For edits, preserve the requested source attributes and do not mutate original files in place unless explicitly approved.
