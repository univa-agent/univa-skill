# Creative Brief - Creative Skill

## When to Use

Use this skill when turning a short user request into a structured objective.
...
Capture objective, audience, platform, duration, aspect ratio, media type, source assets, references, hard constraints, assumptions, exclusions, and missing information. The brief guides planning but does not approve tool execution.
