# Video Generation Prompting - Creative Skill

## When to Use

Use this skill when writing prompts for `text2video_gen`, `image2video_gen`, or `frame2frame_video_gen`.
...
Use the UniVA 7-component structure plus the universal 5-aspect formula. Include subject, subject motion, scene/layers, spatial design, camera language, atmosphere, stylization, and transformation when relevant. Short prompts give freedom; long structured prompts give control. Multi-shot generation must hand off the approved `expanded_generation_prompt` for each shot.
