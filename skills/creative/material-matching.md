# Material Matching - Creative Skill

## When to Use

Use this skill when mapping user assets, generated assets, reference assets, and fallbacks to shots.
...
Record source paths, roles, required/optional status, reuse rules, missing assets, and fallback strategy for every shot or subtask.
