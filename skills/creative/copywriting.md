# Copywriting - Creative Skill

## When to Use

Use this skill when planning hooks, voiceover, subtitles, on-screen text, CTA, and per-shot information points.
...
Keep copy short, readable, paced by duration, and tied to each shot. Voiceover is planned only when explicitly requested. Long readable text should be handled by captions or Remotion rather than generated into pixels.
