# Video Analysis - Creative Skill

## When to Use

Use this skill when analyzing reference or source video for style, rhythm, structure, content, and reusable generation prompts.
...
Capture visible content, shot structure, camera behavior, pace, audio, style, constraints, and limitations. Analysis is read-only unless paired with an approved edit/generate plan.
