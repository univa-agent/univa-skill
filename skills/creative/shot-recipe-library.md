# Shot Recipe Library - Creative Skill

## When to Use

Use this skill when selecting reusable UniVA shot recipes.
...
Use recipe names to choose shot size, angle, motion, purpose, continuity role, and transition fit. Recipes guide planning and must still be expanded into concrete prompts.
