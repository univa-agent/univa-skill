# Duration Planning - Creative Skill

## When to Use

Use this skill when assigning shot counts and shot durations.
...
Allocate time by narrative beat and provider constraints, not by equal slicing. Respect reading time, holds, transitions, minimum generation duration, and final target duration. Merge adjacent beats when target duration is too short.
