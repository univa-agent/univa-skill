# Energy Arc - Creative Skill

## When to Use

Use this skill when planning rhythm, emotion, information density, climax, and resolution.
...
Define the opening hook, build, peak, release, and ending. Match shot duration, transition intensity, copy density, and audio energy to that arc.
