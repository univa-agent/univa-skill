# Asset Generation - Creative Skill

## When to Use

Use this skill when generating keyframes, character images, video clips, merge outputs, and final automatic non-voice audio.
...
Follow the approved asset manifest and shot plan. Generate only required assets, verify every path, preserve intermediate artifacts, and keep final audio cohesive.
