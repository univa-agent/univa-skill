# Transition Sound Caption - Creative Skill

## When to Use

Use this skill when planning transitions, tail-to-head handoff, captions, BGM, SFX, and timeline audio.
...
Transitions must serve continuity or meaning. Every transition needs a handoff rule. Captions and audio should be timeline-aware; voiceover is included only on explicit request.
