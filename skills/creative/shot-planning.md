# Shot Planning - Creative Skill

## When to Use

Use this skill when designing shots, shot size, angle, camera motion, continuity, and visual variety.
...
Plan each shot with purpose, duration, camera language, subject action, start/end states, continuity anchors, duplicate guard, transition out, and visual logic.
