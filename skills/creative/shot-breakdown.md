# Shot Breakdown - Creative Skill

## When to Use

Use this skill when decomposing a brief, proposal, or script into per-shot specifications.
...
Produce shot IDs, objective, duration, prompt components, assets, references, camera language, start/end states, transition needs, and validation checks.
