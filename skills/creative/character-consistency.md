# Character Consistency - Creative Skill

## When to Use

Use this skill when the same character or entity appears across multiple shots.
...
Define identity anchors, wardrobe/material anchors, face/body constraints when allowed, role in each shot, reference images, and drift checks.
