# Video Edit Execute Director - Pipeline Director Skill

## Stage Role

Use this director to execute an approved video edit proposal.

## Responsibilities

Load the approved proposal, call only the approved tool request, verify output, and report deviations.
