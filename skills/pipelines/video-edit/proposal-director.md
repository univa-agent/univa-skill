# Video Edit Proposal Director - Pipeline Director Skill

## Stage Role

Use this director to write an executable edit proposal.

## Responsibilities

Select exact tool, parameters, source references, change list, preservation list, output policy, validation checks, and approval choices.
