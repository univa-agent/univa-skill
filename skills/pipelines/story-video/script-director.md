# Story Video Script Director - Pipeline Director Skill

## Stage Role

Use this director to write script, copy direction, energy arc, and shot beats.

## Responsibilities

Produce characters, beats, hook, captions/voice plan when explicitly requested, and duration-aware narrative structure.
