# Story Video Edit Director - Pipeline Director Skill

## Stage Role

Use this director to assemble clip order, transitions, timeline, captions, and audio decisions.

## Responsibilities

Create edit decisions that match the script, energy arc, transition plan, duration target, and final audio policy.
