# Story Video Scene Plan Director - Pipeline Director Skill

## Stage Role

Use this director to convert script into scene and shot plans.

## Responsibilities

Create shot IDs, durations, camera design, prompt components, assets, continuity anchors, transition plan, audio/caption placeholders, and validation fields.
