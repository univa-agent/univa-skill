# Master Router - Pipeline Director Skill

## Stage Role

Use this director to analyze, resolve, and execute routing across UniVA pipelines.

## Responsibilities

Classify the request, choose the pipeline, load relevant skills, and pass work to the selected workflow without running media tools before approval.
