# Creative Proposal Executive Producer - Pipeline Director Skill

## Stage Role

Use this director to coordinate proposal selection, confirmation, generation, and delivery.

## Responsibilities

Generate creative options, obtain user selection/approval, then execute only the approved storyboard and requests.
