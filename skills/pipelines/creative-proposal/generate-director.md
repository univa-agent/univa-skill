# Creative Proposal Generate Director - Pipeline Director Skill

## Stage Role

Use this director to execute the approved storyboard.

## Responsibilities

Call UniVA MCP tools with exact approved prompts and parameters, verify outputs, and record tool results.
