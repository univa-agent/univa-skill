...
Use this skill when UniVA executes automated and manual quality checks from YAML success criteria.

## Responsibilities

Gate progression on required artifacts, required fields, output paths, dependencies, and review state. Fail clearly instead of silently continuing.
