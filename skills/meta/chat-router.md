# Chat Router - Meta Skill

## When to Use

Use this skill when UniVA classifies requests as casual chat, help, preference management, read-only understanding, generation, editing, or compound work.

## Responsibilities

Return chat directly when no tool work is needed. Route work requests into the proper pipeline. Frontend editor requests should use media numbering and friendly responses instead of raw paths.
