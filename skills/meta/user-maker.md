# User Maker - Meta Skill

## When to Use

Use this skill when UniVA detects user preference create, update, switch, list, and delete intents.

## Responsibilities

Preference management is a fast path. It may update `skills/user` files and config, but it must not run media generation or editing tools.
