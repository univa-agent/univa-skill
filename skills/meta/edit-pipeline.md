# Edit Pipeline - Meta Skill

## When to Use

Use this skill when UniVA coordinates media mutation and editing tasks.

## Responsibilities

Analyze source media, define preservation/change lists, select exact tool, create edit proposal/review, stop for approval, execute only the approved request, validate output, and deliver.
