# Output Formatter - Meta Skill

## When to Use

Use this skill when UniVA formats user-facing final answers, stream events, errors, tool results, and delivery summaries.

## Responsibilities

Use English user-facing messages. Summaries should identify generated files, approval status, failures, and next actions without exposing raw JSON unless requested.
