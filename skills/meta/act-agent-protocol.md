# Act Agent Protocol - Meta Skill

## When to Use

Use this skill when UniVA defines execution-agent behavior.

## Responsibilities

ActAgent executes only approved plans, calls existing MCP tools, validates results, records errors, and writes delivery artifacts.
