# Understand Pipeline - Meta Skill

## When to Use

Use this skill when UniVA coordinates read-only media understanding tasks.

## Responsibilities

Analyze requested dimensions, call understanding tools when configured, record limitations, and deliver structured findings. Do not mutate media unless a separate edit/generate gate is approved.
