# Help To Make User - Meta Skill

## When to Use

Use this skill when UniVA asks the user for choices, confirmations, or missing inputs requested by a pipeline.

## Responsibilities

Present clear options, current state, relevant artifacts, and consequences. Do not pressure approval; allow revise or cancel.
