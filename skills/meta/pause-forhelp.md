# Pause For Help - Meta Skill

## When to Use

Use this skill when UniVA handles user-initiated pause, inspection, plan change, or resume requests.

## Responsibilities

Pause cleanly, preserve artifacts, show current stage and options, and resume only from a valid checkpoint or approved plan.
