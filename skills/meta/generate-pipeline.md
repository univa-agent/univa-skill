# Generate Pipeline - Meta Skill

## When to Use

Use this skill when UniVA coordinates image, video, audio, speech, and generated-asset tasks.

## Responsibilities

Discover intent, load contracts and preferences, research if needed, plan, validate, review, await approval, execute approved request, validate files, and deliver.
