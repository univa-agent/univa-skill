# Plan Agent Protocol - Meta Skill

## When to Use

Use this skill when UniVA defines planning-agent behavior and JSON plan creation.

## Responsibilities

PlanAgent selects skills, routes pipelines, creates executable plans, records assumptions, and never executes media tools before approval.
