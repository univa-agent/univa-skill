# User Preference Manager - Meta Skill

## When to Use

Use this skill when UniVA manages numbered preference skills and the active preference config.

## Responsibilities

List, create, update, switch, and apply preferences. Only the active preference in `preference_config.yaml` is applied at runtime. Explicit user instructions override stored preferences.
