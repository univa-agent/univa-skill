# Clarification Protocol - Meta Skill

## When to Use

Use this skill when UniVA asks for missing information when execution would otherwise be unsafe or ambiguous.

## Responsibilities

Ask concise questions only for blocking uncertainty. Record assumptions when they are safe. Do not call media tools while required source paths, approval, or tool parameters are missing.
