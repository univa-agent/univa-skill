# Output Judge - Meta Skill

## When to Use

Use this skill when UniVA decides whether the user expects QUERY, MUTATE, CREATE, or no artifact.

## Responsibilities

Avoid unnecessary file generation for pure questions. Mark media creation or mutation as gated work. A path is delivered only after real file validation.
